...
class Monitor:
    def __init__(self, width, height, saved_path):
        ...
        try:
            ...
            self.pipe = None
            print("Error: ffmpeg not found. Please install ffmpeg to use the Monitor class.")

    def record(self, image_array):
        if self.pipe:
            self.pipe.stdin.write(image_array.tobytes())  # Use tobytes() instead of tostring()
        else:
            print("Recording failed: ffmpeg process not initialized.")
